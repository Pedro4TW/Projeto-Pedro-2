...
for country_n=1:Ncountries   % alternatives: large_countries or all_countries
...
%%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   file  = [ datafolder_Eurogeog_country,'popplaces_sedac.mat'];   % load SEDAC
   temp = load(file);   
...
%%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    default_cellsize = 1;   % default size is 100km by 100km
    adjust_cellsize = 0;  % if =1, scale cell size up or down to limit number of cells
...
%%  %%%%%%%%%%%%%%%%%%%%
    ...
    country_graph.code_control = code_control;
        ...
        save( [ path_save_grids,country,'_roads_EGM8_large_cells.mat'],'roads' );   
