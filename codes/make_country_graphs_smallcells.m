...
large_countries = [ 6 8 10 14 ];

for country_n=large_countries  % alternatives: large_countries or all_countries
...
%%  %%%%%%%%%%%%%%%%%%%%
    ...
    country_graph.code_control = code_control;
        ...
        save( [ path_save_grids,country,'_roads_EGM8_small_cells.mat'],'roads' );   
