...
exclude = {'KS','MT','BG','GB','GR','HR','NO','RO','UA','IS','PL','SE','EE','RS',...
           'CY','LU','MK','ND','SI',...  % countries too small to work with with 100 km cells
           'GE','MD',... % countries without NUTS classification
           'LT','LV'};   % further exclude countries with just 1 or 2 NUTS2
